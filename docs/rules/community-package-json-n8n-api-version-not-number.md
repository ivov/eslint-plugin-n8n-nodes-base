...
# community-package-json-n8n-api-version-not-number
...
- [Rule source](../../lib/rules/community-package-json-n8n-api-version-not-number.ts)
- [Test source](../../tests/community-package-json-n8n-api-version-not-number.test.ts)
