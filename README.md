...
| [node-param-display-name-wrong-for-dynamic-multi-options](docs/rules/node-param-display-name-wrong-for-dynamic-multi-options.md) | `displayName` for dynamic-multi-options-type node parameter must end with `Name or ID` | Yes, safe |
...
| [node-param-placeholder-missing-email](docs/rules/node-param-placeholder-missing-email.md) | `ID` in `placeholder` in node parameter must be fully uppercased. | Yes, safe |
