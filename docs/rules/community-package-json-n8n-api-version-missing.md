...
# community-package-json-n8n-api-version-missing
...
- [Rule source](../../lib/rules/community-package-json-n8n-api-version-missing.ts)
- [Test source](../../tests/community-package-json-n8n-api-version-missing.test.ts)
