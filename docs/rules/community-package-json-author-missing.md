...
# community-package-json-author-missing
...
- [Rule source](../../lib/rules/community-package-json-author-missing.ts)
- [Test source](../../tests/community-package-json-author-missing.test.ts)
