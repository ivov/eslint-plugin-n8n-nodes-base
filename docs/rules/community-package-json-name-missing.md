...
# community-package-json-name-missing
...
- [Rule source](../../lib/rules/community-package-json-name-missing.ts)
- [Test source](../../tests/community-package-json-name-missing.test.ts)
